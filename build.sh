...
./configure --enable-fuse --enable-extfs --enable-xfs --enable-hfsp --enable-apfs --enable-fat --enable-exfat --enable-f2fs --enable-btrfs --enable-ncursesw --enable-static --enable-mtrace --enable-fs-test --enable-static=no
